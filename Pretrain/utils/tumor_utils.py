...
def get_loader(args):
    data_dir = "../DATASET/nnFormer_preprocessed/Task003_tumor/pretrain_data"
    ...
    # if "contrast" in args.pretrain_mode or "byol" in args.pretrain_mode or "mae" in args.pretrain_mode:
    #     train_transform = transforms.Compose(
    #         [
