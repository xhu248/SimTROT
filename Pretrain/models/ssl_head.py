...
class SSLHead(nn.Module):
    def __init__(self, args, upsample="deconv", dim=1536):
        ...
        if args.model == 'swin':
            ...
            self.encoder = Encoder(pretrain_img_size=(64, 128, 128),
                                   window_size=[4,4,8,4],
        ...
        if upsample == "large_kernel_deconv":
            ...
            self.conv = nn.Sequential(
                ...
                nn.ConvTranspose3d(dim // 32, args.in_channels, kernel_size=(2, 2, 2), stride=(1, 2, 2)),
            )
        elif upsample == "vae":
            self.conv = nn.Sequential(
