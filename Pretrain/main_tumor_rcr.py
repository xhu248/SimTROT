...
from models.ssl_head_tumor import SSLHead
...
def main():
    ...
    def train(args, global_step, train_loader, val_best, scaler):
        ...
        for step, batch in enumerate(train_loader):
            ...
            if val_cond:
                ...
                save_ckp(checkpoint, logdir + "/model_rcr.pt")
    ...
    parser.add_argument("--dataset", default="Task03_tumor", type=str, help="optimization algorithm")
    parser.add_argument("--json_file", default="jsons/data_tumor.json", type=str, help="optimization algorithm")
