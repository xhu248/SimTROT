...
from nnformer.run.load_pretrained_weights import load_pretrained_weights, load_checkpoint
...
def main():
    ...
    parser.add_argument('-pretrain_mode', type=str, required=False, default=None,
                        help='pretrain_mode')
    ...
    if args.pretrain_mode is not None:
        output_folder_name = output_folder_name + args.pretrain_mode
    ...
    if not validation_only:
        if args.continue_training:
            ...
            ckpt_path = '/afs/crc.nd.edu/user/x/xhu7/Private/research_project/2022/vision_transformer/Pretrain/runs' + \
                                    '/results/' + args.pretrained_weights
            state_dict = torch.load(ckpt_path)["state_dict"]
            load_checkpoint(trainer.network, state_dict, args.pretrain_mode)
        else:
