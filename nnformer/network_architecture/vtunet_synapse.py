...
class VTUNet(SegmentationNetwork):
    def __init__(self, pretrain_ckpt="./pretrained_ckpt/swin_tiny_patch4_window7_224_22k.pth", num_classes=14,
        ...
        # changes made from tumor to synapse: img_size, in_chans, num_classes
        self.swin_unet = SwinTransformerSys3D(img_size=(64, 128, 128),
                                            patch_size=(4, 4, 4),
                                            in_chans=1,
        ...
        # variable for SegmentationNetwork class
