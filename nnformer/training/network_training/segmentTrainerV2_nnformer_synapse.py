...
class segmentTrainerV2_nnformer_synapse(nnFormerTrainer_synapse):
    """
    ...
    def initialize_network(self):
        ...
        #     checkpoint = torch.load('~/Private/research_project/2022/vision_transformer/Pretrain/runs' + \
        #                             '/results/nnformer_contrast/model_pretrain_contrast.pt',
        #                             map_location='cpu')
        #     state_dict = checkpoint['state_dict']
        #     self.network.model_down.load_state_dict(checkpoint)
