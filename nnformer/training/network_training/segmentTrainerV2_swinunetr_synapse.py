...
from nnformer.network_architecture.swin_unetr import SwinUNETR
...
class segmentTrainerV2_swinunetr_synapse(nnFormerTrainer_synapse):
    """
    ...
    def initialize_network(self):
        ...
        self.network = SwinUNETR(img_size=(64,128,128),
                  in_channels=1,
                  out_channels=14,
                  feature_size=48,
                  use_checkpoint=True,
