...
from nnformer.network_architecture.vtunet_synapse import VTUNet
...
class segmentTrainerV2_vtunet_synapse(nnFormerTrainer_synapse):
    """
    ...
    def initialize_network(self):
        ...
        cfg = "/afs/crc.nd.edu/user/x/xhu7/Private/research_project/2022/vision_transformer/nnFormer/nnformer/" + \
              "configs/vt_unet_base.yaml"
        with open(cfg, 'r') as f:
            yaml_cfg = yaml.load(f, Loader=yaml.FullLoader)

        self.network = VTUNet(pretrain_ckpt=yaml_cfg.get("MODEL").get("PRETRAIN_CKPT"), num_classes=14,
